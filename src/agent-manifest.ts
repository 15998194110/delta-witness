...
export function agentJsonManifest(
  ...
  return {
    ...
    contact: {
      ...
      a2a: `${publicOrigin}/.well-known/agent-card.json`,
    ...
    skills: [
      {
        ...
        tags: ["web", "evidence", "capture", "x402"],
      ...
      },
      {
        ...
        tags: ["web", "evidence", "preflight", "autonomous-actions", "x402"],
      ...
      },
      {
        ...
        tags: ["web", "evidence", "guarded-action", "workflow-safety", "x402"],
