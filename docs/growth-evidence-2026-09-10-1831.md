...
| PulseFeed | included in crawl; prober method bug fixed by operator | nightly stored-record rewrite pending at counterpart; live paths independently re-probed healthy by counterpart | 0 commercial | 0 | counterpart reports roughly one external paid x402 call/week across its catalogue | 0 | counterpart independently observed current 402 challenges | 0 | $0 | $0 | $0 integration fee | n/a | A for explicit operator correspondence; B for reported market aggregate |
| x402 Arena | six existing DELTA registrations | live public arena entries | 0 shown | 0 shown | public leaderboard shows paid neighboring verification/web-intelligence endpoints, but Arena on-chain verification is not yet sufficient for DELTA revenue accounting | 0 shown | 0 shown | 0 shown | $0 | $0 | $0 listing fee | n/a | B — public marketplace telemetry, not DELTA Treasury evidence |
